	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
	        ...
	        while ((read = filecontent.read(bytes)) != -1) {
	            out.write(bytes, 0, read);   // Copying upload file data to local directory
	        } 
	        ...
	        image1URL = "https://storage.googleapis.com/exercisefb_images/red.jpg";
	        image2URL = "https://storage.googleapis.com/exercisefb_images/green.jpg";
	        image3URL = "https://storage.googleapis.com/exercisefb_images/blue.jpg";
	        ...
	        System.out.println(mergeFileURL);
	        
	        try (BufferedInputStream inputStream = new BufferedInputStream(new URL(mergeFileURL).openStream());
		    	FileOutputStream fileOS = new FileOutputStream(basePath + mergeFile)) {
